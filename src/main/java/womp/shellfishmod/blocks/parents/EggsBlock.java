...
public class EggsBlock extends Block implements Waterloggable {
    ...
    @Override
    public ItemActionResult onUseWithItem(ItemStack item, BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        return super.onUseWithItem(item, state, world, pos, player, hand, hit);
    }
}
