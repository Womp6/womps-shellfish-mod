...
public class ShellfishLandPlantBlock extends FernBlock {
    ...
    protected boolean canPlantOnTop(BlockState floor, BlockView world, BlockPos pos) {
        return (floor.isIn(BlockTags.SAND) || super.canPlantOnTop(floor, world, pos) || floor.isOf(Blocks.CLAY) || floor.isOf(Blocks.MUD))
            && (waterOnly || world.getFluidState(pos.up()).isIn(FluidTags.WATER) ? world.getBlockState(pos.up(2)).isTransparent(world, pos.up(2)) && world.getFluidState(pos.up(2)).isEmpty() : true);
    }
