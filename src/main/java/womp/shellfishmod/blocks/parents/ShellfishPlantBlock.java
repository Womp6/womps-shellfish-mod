...
public class ShellfishPlantBlock extends VegetationBlock implements LiquidBlockContainer {
    ...
    public ShellfishPlantBlock(BlockBehaviour.Properties settings, VoxelShape shape, PlaceType placeType) {
        super(settings);
        this.shape = shape;
    ...
    public ShellfishPlantBlock(BlockBehaviour.Properties settings, VoxelShape shape, PlaceType placeType, MapCodec<? extends ShellfishPlantBlock> codec) {
        super(settings);
        this.shape = shape;
        this.placeType = placeType;
        this.codec = codec;
    ...
    protected boolean mayPlaceOn(BlockState floor, BlockGetter world, BlockPos pos) {
        ...
        if (placeType.equals(PlaceType.MUD_SAND)) {
            return (block.getBlock().equals(Blocks.SAND) || block.getBlock().equals(Blocks.MUD)) && fluid.getType().equals(Fluids.WATER);
    ...
    @Override
    public boolean canPlaceLiquid(LivingEntity arg0, BlockGetter arg1, BlockPos arg2, BlockState arg3, Fluid arg4) {
        return false;
    }
