...
public class CrabModel extends EntityModel<ShellfishRenderState<CrabEntity.Variant>> {
	...
	public void setAngles(ShellfishRenderState<CrabEntity.Variant> entity) {
		...
		if (!entity.touchingWater) {
			this.animateWalking(MoreShellfishAnimations.CRAB_WALK, entity.limbSwingAnimationProgress, entity.limbSwingAmplitude, 12, 15f);
		}
		this.animate(entity.moveAnimationState, MoreShellfishAnimations.CRAB_WALK, entity.age, 2f);
		this.animate(entity.idleAnimationState, MoreShellfishAnimations.CRAB_IDLE, entity.age, 1f);
	}
}
