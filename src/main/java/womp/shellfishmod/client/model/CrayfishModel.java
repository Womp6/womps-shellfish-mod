...
public class CrayfishModel extends EntityModel<ShellfishRenderState<CrayfishEntity.Variant>> {
	...
	public CrayfishModel(ModelPart root) {
		super(root);
		this.moveAnimation = MoreShellfishAnimations.CRAYFISH_WALK.createAnimation(root);
		this.idleAnimation = MoreShellfishAnimations.CRAYFISH_IDLE.createAnimation(root);
	}

	public static TexturedModelData getTexturedModelData() {
		ModelData modelData = new ModelData();
		ModelPartData modelPartData = modelData.getRoot();
		ModelPartData crayfish = modelPartData.addChild("crayfish", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 24.0F, 0.0F));
		...
		.uv(10, 17).cuboid(-2.0F, -3.0F, 1.0F, 4.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));

		ModelPartData tail = body.addChild("tail", ModelPartBuilder.create().uv(1, 1).cuboid(-1.5F, -2.25F, 2.0F, 3.0F, 1.0F, 7.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		.uv(13, 0).cuboid(-4.5F, -1.25F, 9.75F, 9.0F, 0.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -0.5F, 0.0F));
		...
		.uv(8, 21).cuboid(-4.0F, -1.0F, -6.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		.uv(0, 21).cuboid(3.0F, -1.0F, -6.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData antennas = body.addChild("antennas", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));

		ModelPartData antenna1 = antennas.addChild("antenna1", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData antenna2 = antennas.addChild("antenna2", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData legs = crayfish.addChild("legs", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));

		ModelPartData leg_1 = legs.addChild("leg_1", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leg_2 = legs.addChild("leg_2", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 2.0F));
		...
		ModelPartData leg_3 = legs.addChild("leg_3", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 4.0F));
		...
		ModelPartData leg_4 = legs.addChild("leg_4", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leg_5 = legs.addChild("leg_5", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 2.0F));
		...
		ModelPartData leg_6 = legs.addChild("leg_6", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 4.0F));
