...
public class LobsterModel extends SinglePartEntityModel<LobsterEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData lobster = modelPartData.addChild("lobster", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

		ModelPartData body = lobster.addChild("body", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, -2.0F));
		...
		ModelPartData claw1 = claw.addChild("claw1", ModelPartBuilder.create(), ModelTransform.pivot(2.0F, 0.0F, 0.0F));
		...
		ModelPartData claw2 = claw.addChild("claw2", ModelPartBuilder.create(), ModelTransform.pivot(2.0F, 0.0F, 0.0F));
		...
		ModelPartData annetna = body.addChild("annetna", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 2.0F));

		ModelPartData antennaantenna = annetna.addChild("antennaantenna", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, -2.0F));
		...
		ModelPartData antenna1 = antenna.addChild("antenna1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData antennaantennatwo = annetna.addChild("antennaantennatwo", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, -2.0F));
		...
		ModelPartData antenna2 = antennatwo.addChild("antenna2", ModelPartBuilder.create(), ModelTransform.pivot(2.0F, 0.0F, 1.0F));
		...
		ModelPartData leg1 = leg.addChild("leg1", ModelPartBuilder.create(), ModelTransform.pivot(2.0F, 0.0F, 0.0F));
		...
		ModelPartData leg2 = leg.addChild("leg2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leg3 = leg.addChild("leg3", ModelPartBuilder.create(), ModelTransform.pivot(-2.0F, 0.0F, 0.0F));
		...
		ModelPartData leg4 = leg.addChild("leg4", ModelPartBuilder.create(), ModelTransform.pivot(2.0F, 0.0F, 0.0F));
		...
		ModelPartData leg5 = leg.addChild("leg5", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leg6 = leg.addChild("leg6", ModelPartBuilder.create(), ModelTransform.pivot(-2.0F, 0.0F, 0.0F));
	...
	@Override
	public void setAngles(LobsterEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.getPart().traverse().forEach(ModelPart::resetTransform);
		if (!entity.isTouchingWater()) {
			this.animateMovement(MoreShellfishAnimations.LOBSTER_WALK, limbSwing, limbSwingAmount, 12, 15f);
		}
		this.updateAnimation(entity.moveAnimationState, MoreShellfishAnimations.LOBSTER_WALK, ageInTicks, 2f);
		this.updateAnimation(entity.idleAnimationState, MoreShellfishAnimations.LOBSTER_IDLE, ageInTicks, 1f);
	}

	@Override
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
		lobster.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
	}
