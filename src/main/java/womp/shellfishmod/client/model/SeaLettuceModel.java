...
public class SeaLettuceModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(0, 15).cuboid(-1.0F, -0.1F, -1.0F, 2.0F, 0.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

		ModelPartData leaf1 = sea_lettuce.addChild("leaf1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf2 = sea_lettuce.addChild("leaf2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf3 = sea_lettuce.addChild("leaf3", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf4 = sea_lettuce.addChild("leaf4", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf5 = sea_lettuce.addChild("leaf5", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf6 = sea_lettuce.addChild("leaf6", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf7 = sea_lettuce.addChild("leaf7", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf8 = sea_lettuce.addChild("leaf8", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf9 = sea_lettuce.addChild("leaf9", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf10 = sea_lettuce.addChild("leaf10", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf11 = sea_lettuce.addChild("leaf11", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf12 = sea_lettuce.addChild("leaf12", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf13 = sea_lettuce.addChild("leaf13", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf14 = sea_lettuce.addChild("leaf14", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf15 = sea_lettuce.addChild("leaf15", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf16 = sea_lettuce.addChild("leaf16", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf17 = sea_lettuce.addChild("leaf17", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf18 = sea_lettuce.addChild("leaf18", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf19 = sea_lettuce.addChild("leaf19", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leaf20 = sea_lettuce.addChild("leaf20", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
	...
	public void render(SeaLettuceBlockEntity blockEntity, MatrixStack matrices, VertexConsumer var2, int var3, int var4) {
