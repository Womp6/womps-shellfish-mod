...
public class SeaSnailModel extends EntityModel<ShellfishRenderState<SeaSnailEntity.Variant>> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData shell3 = shell.addChild("shell3", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData shell4 = shell.addChild("shell4", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
		...
		ModelPartData shell5 = shell.addChild("shell5", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
