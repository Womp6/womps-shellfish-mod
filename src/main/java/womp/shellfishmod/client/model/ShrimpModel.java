...
public class ShrimpModel extends EntityModel<ShellfishRenderState<ShrimpEntity.Variant>> {
	...
	public void setAngles(ShellfishRenderState<ShrimpEntity.Variant> entity) {
		...
		if (!entity.touchingWater) {
			this.animateWalking(ShellfishAnimations.SHRIMP_WALK, entity.limbFrequency, entity.limbAmplitudeMultiplier, 12, 15f);
		}
		this.animate(entity.idleAnimationState, ShellfishAnimations.SHRIMP_IDLE, entity.age, 1f);
		this.animate(entity.moveAnimationState, ShellfishAnimations.SHRIMP_SWIM, entity.age, 2f);
	}
}
