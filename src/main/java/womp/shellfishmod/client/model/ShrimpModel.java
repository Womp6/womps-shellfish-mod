...
public class ShrimpModel extends SinglePartEntityModel<ShrimpEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData shrimp = modelPartData.addChild("shrimp", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

		ModelPartData main = shrimp.addChild("main", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		main.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-2.0F, -3.0F, -5.25F, 4.0F, 2.0F, 5.0F, new Dilation(0.0F))
		.uv(14, 0).cuboid(-2.0F, -3.0F, -6.25F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		.uv(3, 14).mirrored().cuboid(1.0F, -2.5F, 4.75F, 1.0F, 0.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData arm = main.addChild("arm", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData arm1 = arm.addChild("arm1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData arm2 = arm.addChild("arm2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData antenna = main.addChild("antenna", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData antenna1 = antenna.addChild("antenna1", ModelPartBuilder.create(), ModelTransform.pivot(1.4F, -2.0F, -4.0F));
		...
		ModelPartData antenna2 = antenna.addChild("antenna2", ModelPartBuilder.create(), ModelTransform.pivot(-1.4F, -2.0F, -4.0F));
		...
		ModelPartData otherantennas = main.addChild("otherantennas", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData ot1 = otherantennas.addChild("ot1", ModelPartBuilder.create(), ModelTransform.pivot(2.0F, -2.0F, -5.0F));
		...
		ModelPartData ot2 = otherantennas.addChild("ot2", ModelPartBuilder.create(), ModelTransform.pivot(-2.0F, -2.0F, -5.0F));
		...
		ModelPartData ot3 = otherantennas.addChild("ot3", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData ot4 = otherantennas.addChild("ot4", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData leg = shrimp.addChild("leg", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData leftlegs = leg.addChild("leftlegs", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData leg1 = leftlegs.addChild("leg1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, -0.7F));
		...
		ModelPartData leg2 = leftlegs.addChild("leg2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, -2.5F));
		...
		ModelPartData leg3 = leftlegs.addChild("leg3", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, -4.25F));
		...
		ModelPartData rightlegs = leg.addChild("rightlegs", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData leg4 = rightlegs.addChild("leg4", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, -0.7F));
		...
		ModelPartData leg5 = rightlegs.addChild("leg5", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, -2.5F));
		...
		ModelPartData leg6 = rightlegs.addChild("leg6", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, -4.25F));
	...
	public void setAngles(ShrimpEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (!entity.isTouchingWater()) {
			this.animateMovement(ShellfishAnimations.SHRIMP_WALK, limbSwing, limbSwingAmount, 12, 15f);
		}
		this.updateAnimation(entity.idleAnimationState, ShellfishAnimations.SHRIMP_IDLE, ageInTicks, 1f);
		this.updateAnimation(entity.swimAnimationState, ShellfishAnimations.SHRIMP_SWIM, ageInTicks, 2f);
	}

	@Override
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, int color) {
		shrimp.render(matrices, vertexConsumer, light, overlay, color);
	}
