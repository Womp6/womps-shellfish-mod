...
public class WaterLettuceModel {
    ...
    public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData lettuce = modelPartData.addChild("lettuce", ModelPartBuilder.create().uv(0, 16).cuboid(-1.5F, -1.25F, -1.5F, 3.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.25F, 0.0F));
