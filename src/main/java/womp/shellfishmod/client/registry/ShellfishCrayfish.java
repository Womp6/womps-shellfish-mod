...
public class ShellfishCrayfish {
    ...
    public static void register() {
        ...
        for (String[] type : crayfish) {
            ItemProperties.register(ShellfishItems.CRAYFISH.get(), new ResourceLocation(type[1]), (stack, world, entity, seed) -> {
                if (stack.hasCustomHoverName() && type[0].equals(stack.getHoverName().getString())) {
                    return 1.0F;
                }
                return 0.0F;
            });
