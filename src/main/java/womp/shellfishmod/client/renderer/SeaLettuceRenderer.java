...
public class SeaLettuceRenderer implements BlockEntityRenderer<SeaLettuceBlockEntity, SeaLettuceBlockEntityRenderState> {
    ...
    public SeaLettuceRenderer(BlockEntityRendererProvider.Context context) {
        this.seaLettuceModel = new SeaLettuceModel(SeaLettuceModel.getTexturedModelData().bakeRoot());
    }

    @Override
    public void submit(SeaLettuceBlockEntityRenderState blockEntity, PoseStack matrices, SubmitNodeCollector queue,
