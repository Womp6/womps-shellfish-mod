...
public class WaterLettuceRenderer implements BlockEntityRenderer<WaterLettuceBlockEntity> {
    ...
    private final ResourceLocation darkTexture = new ResourceLocation("shellfish", "textures/block/water_lettuce_dark.png");
    private final ResourceLocation marshTexture = new ResourceLocation("shellfish", "textures/block/water_lettuce_marsh.png");
    private final ResourceLocation defaultTexture = new ResourceLocation("shellfish", "textures/block/water_lettuce.png");
    ...
    @Override
    public void render(WaterLettuceBlockEntity blockEntity, float tickDelta, PoseStack matrices, MultiBufferSource vertexConsumers, int light, int overlay) {
        ...
        if (ShellfishConfig.getShellfishGraphics() >= 1) {
            ...
            lettuceModel.render(matrices, vertexConsumers.getBuffer(RenderType.entityCutout(getTexture(blockEntity))), light, overlay);
