...
public class WaterLettuceRenderer implements BlockEntityRenderer<WaterLettuceBlockEntity, WaterLettuceBlockEntityRenderState> {
    ...
    @Override
    public void submit(WaterLettuceBlockEntityRenderState blockEntity, PoseStack matrices, SubmitNodeCollector queue, CameraRenderState camera) {
        ...
        if (ShellfishConfig.getShellfishGraphics() >= 1) {
            ...
            lettuceModel.render(blockEntity, matrices, queue, camera);
