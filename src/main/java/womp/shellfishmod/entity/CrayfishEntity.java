...
public class CrayfishEntity extends ShellfishEntity<Variant> implements Hungry, EggLaying {
    ...
    public static DefaultAttributeContainer.Builder createCrayfishAttributes() {
        return HostileEntity.createMobAttributes().add(EntityAttributes.MAX_HEALTH, 8.0d).add(EntityAttributes.ATTACK_DAMAGE, 1.0d).add(EntityAttributes.MOVEMENT_SPEED, 0.14);
    }
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(2, new HungryActiveTargetGoal<>(this, TurtleEntity.class, 10, true, true, (entity, world) -> {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        ...
        if((child = ShellfishEntities.CRAYFISH.create(world, SpawnReason.BREEDING)) != null && entity instanceof CrayfishEntity mate) {
