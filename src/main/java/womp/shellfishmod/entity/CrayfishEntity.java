...
public class CrayfishEntity extends ShellfishEntity<Variant> implements Hungry, EggLaying {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(0, new ShellfishLayEggGoal(this, 1, ShellfishSounds.CRAYFISH_LAYS_EGGS, ShellfishBlocks.CRAYFISH_EGGS_BLOCK));
        ...
        this.targetSelector.addGoal(2, new HungryActiveTargetGoal<>(this, Turtle.class, 10, true, true, (entity, world) -> {
    ...
    public AgeableMob getBreedOffspring(ServerLevel world, AgeableMob entity) {
        ...
        if((child = ShellfishEntities.CRAYFISH.create(world, EntitySpawnReason.BREEDING)) != null && entity instanceof CrayfishEntity mate) {
