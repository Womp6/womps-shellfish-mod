...
public class LobsterEntity extends ShellfishEntity<Variant> implements Hungry, EggLaying {
    ...
    public static DefaultAttributeContainer.Builder createLobsterAttributes() {
        return HostileEntity.createMobAttributes().add(EntityAttributes.MAX_HEALTH, 10.0d).add(EntityAttributes.ATTACK_DAMAGE, 2.0d).add(EntityAttributes.MOVEMENT_SPEED, .15);
    }
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        LobsterEntity child;
        if((child = ShellfishEntities.LOBSTER.create(world, SpawnReason.BREEDING)) != null && entity instanceof LobsterEntity mate) {
