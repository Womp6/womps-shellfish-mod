...
public class MossBallEntity extends WaterAnimal implements Bucketable, VariantHolder<MossBallEntity.Variant> {
    ...
    public void loadFromBucketTag(CompoundTag var1) {
        ...
        this.setVariant(Variant.byId(var1.getInt("Variant")));
    }
