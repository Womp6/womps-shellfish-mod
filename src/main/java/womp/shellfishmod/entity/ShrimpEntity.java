...
public class ShrimpEntity extends ShellfishEntity implements EggLaying {
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        ShrimpEntity child;
        if((child = ShellfishEntities.SHRIMP.create(world)) != null && entity instanceof ShrimpEntity mate) {
    ...
    extends MoveControl {
        ...
        public void tick() {
            if (this.shrimp.isTouchingWater()) {
                ...
                float f = (float)(this.speed * this.shrimp.getAttributeValue(EntityAttributes.GENERIC_MOVEMENT_SPEED));
