...
public class ShellfishBucketItem extends MobBucketItem {
    ...
    public ShellfishBucketItem(Supplier<EntityType<? extends Mob>> entityType, Fluid fluid, Item item, boolean hasTooltip, Properties settings) {
        super(entityType.get(), fluid, SoundEvents.BUCKET_EMPTY_FISH, settings);
