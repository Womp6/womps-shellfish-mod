...
public class ShellfishBlocks {
    ...
    private static Block registerLandWaterPlant(String name, boolean waterOnly, Block tallPlantBlock, boolean grass) {
        return register(name, grass ? new ShellfishLandPlantBlock(AbstractBlock.Settings.copy(Blocks.GRASS), waterOnly, tallPlantBlock) : new WaterFlowerBlock(AbstractBlock.Settings.copy(Blocks.DANDELION), tallPlantBlock), name);
    }

    private static Block registerTallPlant(String name, boolean waterOnly, boolean grass) {
        Block block = new ShellfishLandTallBlock(AbstractBlock.Settings.copy(grass ? Blocks.GRASS : Blocks.DANDELION), waterOnly);
