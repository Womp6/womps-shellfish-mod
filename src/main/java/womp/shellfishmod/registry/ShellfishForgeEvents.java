...
public class ShellfishForgeEvents {
    ...
    public static void customTrades(VillagerTradesEvent event) {
        if (event.getType() == ShellfishTrapper.SHELLFISH_TRAPPER.get()) {
            ...
            factories.get(1).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.RAW_CRAYFISH.get(), 12),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .02f
            ));
            factories.get(1).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.RAW_LOBSTER.get(), 12),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .03f
            ));
            factories.get(1).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.RAW_CRAB.get(), 12),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .02f
            ));
            factories.get(1).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.RAW_SHRIMP.get(), 12),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .02f
            ));
            factories.get(1).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.RAW_SEA_SNAIL.get(), 8),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .02f
            ));
            factories.get(1).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.RAW_UNI.get(), 16),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .02f
            ));
            factories.get(1).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.RAW_CLAM.get(), 16),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .02f
            ));
            factories.get(1).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.RAW_OYSTER.get(), 16),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .02f
            ));
            factories.get(1).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.RAW_MUSSEL.get(), 16),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .02f
            ));
            factories.get(1).add((entity, random) -> new MerchantOffer(
            ...
            factories.get(2).add((entity, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(ShellfishItems.RAW_CRAYFISH.get(), 6),
                    new ItemStack(ShellfishItems.COOKED_CRAYFISH.get(), 6),
                    8, 10, .03f
            ));
            factories.get(2).add((entity, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(ShellfishItems.RAW_LOBSTER.get(), 6),
                    new ItemStack(ShellfishItems.COOKED_LOBSTER.get(), 6),
                    8, 10, .03f
            ));
            factories.get(2).add((entity, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(ShellfishItems.RAW_CRAB.get(), 6),
                    new ItemStack(ShellfishItems.COOKED_CRAB.get(), 6),
                    8, 10, .03f
            ));
            factories.get(2).add((entity, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(ShellfishItems.RAW_SHRIMP.get(), 6),
                    new ItemStack(ShellfishItems.COOKED_SHRIMP.get(), 6),
                    8, 10, .03f
            ));
            factories.get(2).add((entity, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(ShellfishItems.RAW_SEA_SNAIL.get(), 4),
                    new ItemStack(ShellfishItems.COOKED_SEA_SNAIL.get(), 4),
                    8, 10, .03f
            ));
            factories.get(2).add((entity, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(ShellfishItems.RAW_UNI.get(), 8),
                    new ItemStack(ShellfishItems.COOKED_UNI.get(), 8),
                    8, 5, .03f
            ));
            factories.get(2).add((entity, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(ShellfishItems.RAW_CLAM.get(), 8),
                    new ItemStack(ShellfishItems.COOKED_CLAM.get(), 8),
                    8, 5, .03f
            ));
            factories.get(2).add((entity, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(ShellfishItems.RAW_OYSTER.get(), 8),
                    new ItemStack(ShellfishItems.COOKED_OYSTER.get(), 8),
                    8, 5, .03f
            ));
            factories.get(2).add((entity, random) -> new MerchantOffer(
                    new ItemStack(Items.EMERALD, 1),
                    new ItemStack(ShellfishItems.RAW_MUSSEL.get(), 8),
            ...
            factories.get(3).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.ROCKWEED.get(), 32),
                    new ItemStack(Items.EMERALD, 1),
                    16, 5, .02f
            ));
            factories.get(3).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.WATER_LETTUCE.get(), 32),
                    new ItemStack(Items.EMERALD, 1),
                    16, 5, .02f
            ));
            factories.get(3).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.PADDLEWEED.get(), 16),
                    new ItemStack(Items.EMERALD, 1),
                    16, 5, .02f
            ));
            factories.get(3).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.EELGRASS.get(), 16),
                    new ItemStack(Items.EMERALD, 1),
                    16, 5, .02f
            ));
            factories.get(3).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.SEA_LETTUCE.get(), 16),
                    new ItemStack(Items.EMERALD, 1),
                    16, 5, .02f
            ));
            ...
            factories.get(5).add((entity, random) -> new MerchantOffer(
                    new ItemStack(ShellfishItems.PEARL.get(), 1),
                    new ItemStack(Items.EMERALD, 1),
                    16, 2, .08f
            ));
        }
