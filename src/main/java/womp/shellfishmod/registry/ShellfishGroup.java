...
public class ShellfishGroup {
    ...
    public static final RegistryObject<CreativeModeTab> GROUP = TABS.register("shellfish_group", () -> CreativeModeTab.builder().icon(() -> new ItemStack(ShellfishItems.CRAYFISH.get())).title(Component.translatable("shellfish.group"))
