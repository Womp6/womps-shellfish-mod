...
public class ShellfishItems {
    ...
    public static final Item CRAYFISH = registerBasic("crayfish");
    ...
    public static final Item RAW_SEA_SNAIL = registerFood("raw_sea_snail", 1, 0.2, StatusEffects.HUNGER, 400, 0, 0.5F, ShellfishBlocks.SEA_SNAIL_SHELL_BLOCK);
    public static final Item COOKED_SEA_SNAIL = registerFood("cooked_sea_snail", 3, 0.6, ShellfishBlocks.SEA_SNAIL_SHELL_BLOCK);
    ...
    public static final Item RAW_CLAM = registerFood("raw_clam", 1, 0.2, StatusEffects.HUNGER, 400, 0, 0.5F, ShellfishBlocks.CLAM_SHELL);
    public static final Item COOKED_CLAM = registerFood("cooked_clam", 3, 0.5, ShellfishBlocks.CLAM_SHELL);
    public static final Item CLAM = registerBasic("clam");
    public static final Item RAW_OYSTER = registerFood("raw_oyster", 1, 0.2, ShellfishBlocks.OYSTER_SHELL);
    public static final Item COOKED_OYSTER = registerFood("cooked_oyster", 3, 0.5, ShellfishBlocks.OYSTER_SHELL);
    public static final Item OYSTER = registerBasic("oyster");
    public static final Item RAW_MUSSEL = registerFood("raw_mussel", 1, 0.1, StatusEffects.HUNGER, 400, 0, 0.5F, ShellfishBlocks.MUSSEL_SHELL);
    public static final Item COOKED_MUSSEL = registerFood("cooked_mussel", 2, 0.4, ShellfishBlocks.MUSSEL_SHELL);
    public static final Item MUSSEL = registerBasic("mussel");

    //SPAWN EGGS AND BUCKETS
    public static final Item CRAYFISH_SPAWN_EGG = registerEgg("crayfish_spawn_egg", ShellfishEntities.CRAYFISH, 11499264, 8871950);
    public static final Item CRAYFISH_BUCKET = registerBucket("crayfish_bucket", ShellfishEntities.CRAYFISH);
    public static final Item LOBSTER_SPAWN_EGG = registerEgg("lobster_spawn_egg", ShellfishEntities.LOBSTER, 0x741617, 0x5A1213);
    public static final Item LOBSTER_BUCKET = registerBucket("lobster_bucket", ShellfishEntities.LOBSTER);
    public static final Item CRAB_SPAWN_EGG = registerEgg("crab_spawn_egg", ShellfishEntities.CRAB, 0x961b1b, 0x771313);
    public static final Item CRAB_BUCKET = registerBucket("crab_bucket", ShellfishEntities.CRAB);
    public static final Item SHRIMP_SPAWN_EGG = registerEgg("shrimp_spawn_egg", ShellfishEntities.SHRIMP, 0xcc580a, 0xb9440f);
    public static final Item SHRIMP_BUCKET = registerBucket("shrimp_bucket", ShellfishEntities.SHRIMP);
    public static final Item SEA_SNAIL_SPAWN_EGG = registerEgg("sea_snail_spawn_egg", ShellfishEntities.SEA_SNAIL, 0xb17b45, 0x553e27);
    public static final Item SEA_SNAIL_BUCKET = registerBucket("sea_snail_bucket", ShellfishEntities.SEA_SNAIL);
    public static final Item SEA_URCHIN_SPAWN_EGG = registerEgg("sea_urchin_spawn_egg", ShellfishEntities.SEA_URCHIN, 0x2e0e61, 0x200847);
    public static final Item SEA_URCHIN_BUCKET = registerBucket("sea_urchin_bucket", ShellfishEntities.SEA_URCHIN);
    public static final Item CLAM_SPAWN_EGG = registerEgg("clam_spawn_egg", ShellfishEntities.CLAM, 0x978a7c, 0x72675b);
    public static final Item CLAM_BUCKET = registerBucket("clam_bucket", ShellfishEntities.CLAM);
    public static final Item OYSTER_SPAWN_EGG = registerEgg("oyster_spawn_egg", ShellfishEntities.OYSTER, 0xbb9a69, 0xaa8e5f);
    public static final Item OYSTER_BUCKET = registerBucket("oyster_bucket", ShellfishEntities.OYSTER);
    public static final Item MUSSEL_SPAWN_EGG = registerEgg("mussel_spawn_egg", ShellfishEntities.MUSSEL, 0x42608a, 0x072049);
    public static final Item MUSSEL_BUCKET = registerBucket("mussel_bucket", ShellfishEntities.MUSSEL);
    public static final Item MOSS_BALL_SPAWN_EGG = registerEgg("moss_ball_spawn_egg", ShellfishEntities.MOSS_BALL, 0x44720c, 0x375f05);
    ...
    public static final Item BURNT_SEA_SNAIL = registerBurnt("burnt_sea_snail", ShellfishBlocks.SEA_SNAIL_SHELL_BLOCK);
    public static final Item BURNT_UNI = registerBurnt("burnt_uni");
    public static final Item BURNT_CLAM = registerBurnt("burnt_clam", ShellfishBlocks.CLAM_SHELL);
    public static final Item BURNT_OYSTER = registerBurnt("burnt_oyster", ShellfishBlocks.OYSTER_SHELL);
    public static final Item BURNT_MUSSEL = registerBurnt("burnt_mussel", ShellfishBlocks.MUSSEL_SHELL);
    ...
    public static final Item ESCARGOT = registerFood("escargot", 8, 0.5, ShellfishBlocks.SEA_SNAIL_SHELL_BLOCK);
    ...
    public static final Item BAKED_CLAM = registerFood("baked_clam", 8, 0.5, ShellfishBlocks.CLAM_SHELL);
    ...
    public static final Item OYSTER_ROCKEFELLER = registerFood("oyster_rockefeller", 8, 0.5, ShellfishBlocks.OYSTER_SHELL);
    ...
    public static final Item STUFFED_MUSSEL = registerFood("stuffed_mussel", 7, 0.5, ShellfishBlocks.MUSSEL_SHELL);
    ...
    //MISC
    public static final Item PEARL = registerBasic("pearl");
    ...
    private static Item registerFood(String name, int hunger, double saturationModifier) {
        return registerItem(name, new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(hunger).saturationModifier((float) saturationModifier).build())));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, ItemConvertible item) {
        return registerItem(name, new ReturnOnConsumptionItem(new Item.Settings().food(new FoodComponent.Builder().hunger(hunger).saturationModifier((float) saturationModifier).build()), item));
    }

    private static Item registerFoodMaxOne(String name, int hunger, double saturationModifier, ItemConvertible item) {
        return registerItem(name, new ReturnOnConsumptionItem(new Item.Settings().food(new FoodComponent.Builder().hunger(hunger).saturationModifier((float) saturationModifier).build()).maxCount(1), item));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, StatusEffect effect, int duration, int amplifier, float chance) {
        return registerItem(name, new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(hunger).saturationModifier((float) saturationModifier).statusEffect(new StatusEffectInstance(effect, duration, amplifier), chance).build())));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, StatusEffect effect, int duration, int amplifier, float chance, ItemConvertible item) {
        return registerItem(name, new ReturnOnConsumptionItem(new Item.Settings().food(new FoodComponent.Builder().hunger(hunger).saturationModifier((float) saturationModifier).statusEffect(new StatusEffectInstance(effect, duration, amplifier), chance).build()), item));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, StatusEffect effect, int duration, int amplifier, float chance, StatusEffect effect2, int duration2, int amplifier2, float chance2) {
        return registerItem(name, new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(hunger).saturationModifier((float) saturationModifier).statusEffect(new StatusEffectInstance(effect, duration, amplifier), chance).statusEffect(new StatusEffectInstance(effect2, duration2, amplifier2), chance2).build())));
    }

    private static Item registerBurnt(String name) {
        return registerItem(name, new Item(new Item.Settings().food((new FoodComponent.Builder()).hunger(1).saturationModifier((float) 0.1).statusEffect(new StatusEffectInstance(StatusEffects.POISON, 400, 1), 1F).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 400, 0), 1F).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 400, 1), 1F).build())));
    }

    private static Item registerBurnt(String name, ItemConvertible item) {
        return registerItem(name, new ReturnOnConsumptionItem(new Item.Settings().food((new FoodComponent.Builder()).hunger(1).saturationModifier((float) 0.1).statusEffect(new StatusEffectInstance(StatusEffects.POISON, 400, 1), 1F).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 400, 0), 1F).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 400, 1), 1F).build()), item));
    }
    ...
    private static Item registerEgg(String name, EntityType<? extends MobEntity> type, int primaryColor, int secondaryColor) {
        return registerItem(name, new SpawnEggItem(type, primaryColor, secondaryColor, new Item.Settings()));
    }
