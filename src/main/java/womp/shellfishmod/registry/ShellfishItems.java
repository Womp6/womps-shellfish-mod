...
public class ShellfishItems {
    ...
    public static final RegistryObject<Item> SEA_LETTUCE = ITEMS.register("sea_lettuce", () -> new BlockItem(ShellfishBlocks.SEA_LETTUCE.get(), new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationModifier((float) 0.1).build())));
    ...
    private static RegistryObject<Item> registerFood(String name, int hunger, double saturationModifier, Supplier<? extends ItemLike> item) {
        return ITEMS.register(name, () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).usingConvertsTo(item.get()).build())));
    }
    ...
    private static RegistryObject<Item> registerFood(String name, int hunger, double saturationModifier, Holder<MobEffect> effect, int duration, int amplifier, float chance, Supplier<? extends ItemLike> item) {
        return ITEMS.register(name, () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).effect(new MobEffectInstance(effect, duration, amplifier), chance).usingConvertsTo(item.get()).build())));
    }

    private static RegistryObject<Item> registerFood(String name, int hunger, double saturationModifier, Holder<MobEffect> effect, int duration, int amplifier, float chance, ItemLike item) {
