...
public class ShellfishItems {
    ...
    //RAW, COOKED, REGULAR
    public static final Item RAW_CRAYFISH = registerFood("raw_crayfish", 1, 0.2, MobEffects.HUNGER, 400, 0, 0.5F);
    public static final Item COOKED_CRAYFISH = registerFood("cooked_crayfish", 4, 0.7);
    public static final Item CRAYFISH = registerItem("crayfish", new CrayfishItem(new Item.Properties().setId(ShellfishUtil.createKey("crayfish", Registries.ITEM))));
    public static final Item RAW_LOBSTER = registerFood("raw_lobster", 2, 0.3, MobEffects.HUNGER, 400, 0, 0.5F);
    ...
    public static final Item RAW_CRAB = registerFood("raw_crab", 1, 0.1, MobEffects.HUNGER, 400, 0, 0.5F);
    public static final Item COOKED_CRAB = registerFood("cooked_crab", 3, 0.6);
    public static final Item CRAB = registerBasic("crab");
    public static final Item RAW_SHRIMP = registerFood("raw_shrimp", 1, 0.2, MobEffects.HUNGER, 400, 0, 0.5F);
    ...
    public static final Item RAW_SEA_SNAIL = registerFood("raw_sea_snail", 1, 0.2, MobEffects.HUNGER, 400, 0, 0.5F, ShellfishBlocks.SEA_SNAIL_SHELL_BLOCK.asItem());
    ...
    public static final Item SEA_URCHIN = registerFood("sea_urchin", 1, 0.1, MobEffects.HUNGER, 400, 0, 1F, MobEffects.POISON, 100, 1, 1F);
    public static final Item RAW_CLAM = registerFood("raw_clam", 1, 0.2, MobEffects.HUNGER, 400, 0, 0.5F, ShellfishBlocks.CLAM_SHELL.asItem());
    ...
    public static final Item RAW_MUSSEL = registerFood("raw_mussel", 1, 0.1, MobEffects.HUNGER, 400, 0, 0.5F, ShellfishBlocks.MUSSEL_SHELL.asItem());
    ...
    public static final Item RAW_SHRIMP_SKEWER = registerFood("raw_shrimp_skewer", 3, 0.3, MobEffects.HUNGER, 400, 0, 0.5F, Items.STICK);
    ...
    //MISC
    public static final Item PEARL = registerItem("pearl", new Item(new Item.Properties().trimMaterial(ShellfishUtil.createKey("pearl", Registries.TRIM_MATERIAL)).setId(ShellfishUtil.createKey("pearl", Registries.ITEM))));
    ...
    private static Item registerBasic(String name) {
        return registerItem(name, new Item(new Item.Properties().setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier) {
        return registerItem(name, new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).build()).setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, Item item) {
        return registerItem(name, new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).build()).usingConvertsTo(item).setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerFoodMaxOne(String name, int hunger, double saturationModifier, Item item) {
        return registerItem(name, new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).build()).stacksTo(1).usingConvertsTo(item).setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, Holder<MobEffect> effect, int duration, int amplifier, float chance) {
        return registerItem(name, new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).build(), food().onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(effect, duration, amplifier), chance)).build()).setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, Holder<MobEffect> effect, int duration, int amplifier, float chance, Item item) {
        return registerItem(name, new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).build(), food().onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(effect, duration, amplifier), chance)).build()).usingConvertsTo(item).setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, Holder<MobEffect> effect, int duration, int amplifier, float chance, Holder<MobEffect> effect2, int duration2, int amplifier2, float chance2) {
        return registerItem(name, new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).build(), food().onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(effect, duration, amplifier), chance)).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(effect2, duration2, amplifier2), chance2)).build()).setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerBurnt(String name) {
        return registerItem(name, new Item(new Item.Properties().food((new FoodProperties.Builder()).nutrition(1).saturationModifier((float) 0.1).build(), food().onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.POISON, 400, 1), 1F)).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.NAUSEA, 400, 0), 1F)).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.HUNGER, 400, 1), 1F)).build()).setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerBurnt(String name, Item item) {
        return registerItem(name, new Item(new Item.Properties().food((new FoodProperties.Builder()).nutrition(1).saturationModifier((float) 0.1).build(), food().onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.POISON, 400, 1), 1F)).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.NAUSEA, 400, 0), 1F)).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.HUNGER, 400, 1), 1F)).build()).usingConvertsTo(item).setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerBucket(String name, EntityType<? extends Mob> type) {
        return registerItem(name, new ShellfishBucketItem(() -> type, Fluids.WATER, Items.BUCKET, true, new Item.Properties().stacksTo(1).craftRemainder(Items.BUCKET).setId(ShellfishUtil.createKey(name, Registries.ITEM))));
    }

    private static Item registerEgg(String name, EntityType<? extends Mob> type) {
        return registerItem(name, new SpawnEggItem(new Item.Properties().setId(ShellfishUtil.createKey(name, Registries.ITEM)).spawnEgg(type)));
    }

    private static Item registerItem(String name, Item factory) {
        return Registry.register(BuiltInRegistries.ITEM, Identifier.fromNamespaceAndPath("shellfish", name), factory);
    }

    public static void register() {
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.ROCKWEED.asItem(), 0.3f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.WATER_LETTUCE.asItem(), 0.65f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.EELGRASS.asItem(), 0.3f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.PADDLEWEED.asItem(), 0.3f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.SEA_LETTUCE.asItem(), 0.3f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.CATTAIL.asItem(), 0.65f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.TALL_CATTAIL.asItem(), 0.65f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.PICKERELWEED.asItem(), 0.65f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.TALL_PICKERELWEED.asItem(), 0.65f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.WHEATGRASS.asItem(), 0.5f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.TALL_WHEATGRASS.asItem(), 0.65f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.WATER_GRASS.asItem(), 0.3f);
        ComposterBlock.COMPOSTABLES.put(ShellfishBlocks.TALL_WATER_GRASS.asItem(), 0.5f);
        ComposterBlock.COMPOSTABLES.put(SHELLFISH_BAIT, 0.3f);
        ComposterBlock.COMPOSTABLES.put(DRIED_SHELLFISH_BAIT, 0.3f);
    }
}
