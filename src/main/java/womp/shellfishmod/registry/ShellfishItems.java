...
public class ShellfishItems {
    ...
    private static Item registerFood(String name, int hunger, double saturationModifier) {
        return registerItem(name, new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).build())));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, ItemConvertible item) {
        return registerItem(name, new ReturnOnConsumptionItem(new Item.Settings().food(new FoodComponent.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).build()), item));
    }

    private static Item registerFoodMaxOne(String name, int hunger, double saturationModifier, ItemConvertible item) {
        return registerItem(name, new ReturnOnConsumptionItem(new Item.Settings().food(new FoodComponent.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).build()).maxCount(1), item));
    }
    ...
    private static Item registerFood(String name, int hunger, double saturationModifier, RegistryEntry<StatusEffect> effect, int duration, int amplifier, float chance) {
        return registerItem(name, new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).statusEffect(new StatusEffectInstance(effect, duration, amplifier), chance).build())));
    }

    private static Item registerFood(String name, int hunger, double saturationModifier, RegistryEntry<StatusEffect> effect, int duration, int amplifier, float chance, ItemConvertible item) {
        return registerItem(name, new ReturnOnConsumptionItem(new Item.Settings().food(new FoodComponent.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).statusEffect(new StatusEffectInstance(effect, duration, amplifier), chance).build()), item));
    }
    ...
    private static Item registerFood(String name, int hunger, double saturationModifier, RegistryEntry<StatusEffect> effect, int duration, int amplifier, float chance, RegistryEntry<StatusEffect> effect2, int duration2, int amplifier2, float chance2) {
        return registerItem(name, new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).statusEffect(new StatusEffectInstance(effect, duration, amplifier), chance).statusEffect(new StatusEffectInstance(effect2, duration2, amplifier2), chance2).build())));
    }

    private static Item registerBurnt(String name) {
        return registerItem(name, new Item(new Item.Settings().food((new FoodComponent.Builder()).nutrition(1).saturationModifier((float) 0.1).statusEffect(new StatusEffectInstance(StatusEffects.POISON, 400, 1), 1F).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 400, 0), 1F).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 400, 1), 1F).build())));
    }

    private static Item registerBurnt(String name, ItemConvertible item) {
        return registerItem(name, new ReturnOnConsumptionItem(new Item.Settings().food((new FoodComponent.Builder()).nutrition(1).saturationModifier((float) 0.1).statusEffect(new StatusEffectInstance(StatusEffects.POISON, 400, 1), 1F).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 400, 0), 1F).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 400, 1), 1F).build()), item));
    }
