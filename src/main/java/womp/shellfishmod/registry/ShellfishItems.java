...
public class ShellfishItems {
    ...
    public static final RegistryObject<Item> WATER_LETTUCE = ITEMS.register("water_lettuce", () -> new PlaceOnWaterBlockItem(ShellfishBlocks.WATER_LETTUCE.get(), new Item.Properties().setId(ShellfishTags.createKey("water_lettuce", Registries.ITEM))));
    ...
    public static final RegistryObject<Item> SEA_LETTUCE = ITEMS.register("sea_lettuce", () -> new BlockItem(ShellfishBlocks.SEA_LETTUCE.get(), new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationModifier((float) 0.1).build()).setId(ShellfishTags.createKey("sea_lettuce", Registries.ITEM))));
    ...
    public static final RegistryObject<Item> DRIFTWOOD = ITEMS.register("driftwood", () -> new DriftwoodItem(ShellfishBlocks.DRIFTWOOD.get(), new Item.Properties().setId(ShellfishTags.createKey("driftwood", Registries.ITEM)), 200));
    ...
    public static final RegistryObject<Item> CRAYFISH = ITEMS.register("crayfish", () -> new CrayfishItem(new Item.Properties().setId(ShellfishTags.createKey("crayfish", Registries.ITEM))));
    ...
    public static final RegistryObject<Item> CRAYFISH_SPAWN_EGG = registerEgg("crayfish_spawn_egg", ShellfishEntities.CRAYFISH);
    public static final RegistryObject<Item> CRAYFISH_BUCKET = registerBucket("crayfish_bucket", ShellfishEntities.CRAYFISH);
    public static final RegistryObject<Item> LOBSTER_SPAWN_EGG = registerEgg("lobster_spawn_egg", ShellfishEntities.LOBSTER);
    public static final RegistryObject<Item> LOBSTER_BUCKET = registerBucket("lobster_bucket", ShellfishEntities.LOBSTER);
    public static final RegistryObject<Item> CRAB_SPAWN_EGG = registerEgg("crab_spawn_egg", ShellfishEntities.CRAB);
    public static final RegistryObject<Item> CRAB_BUCKET = registerBucket("crab_bucket", ShellfishEntities.CRAB);
    public static final RegistryObject<Item> SHRIMP_SPAWN_EGG = registerEgg("shrimp_spawn_egg", ShellfishEntities.SHRIMP);
    public static final RegistryObject<Item> SHRIMP_BUCKET = registerBucket("shrimp_bucket", ShellfishEntities.SHRIMP);
    public static final RegistryObject<Item> SEA_SNAIL_SPAWN_EGG = registerEgg("sea_snail_spawn_egg", ShellfishEntities.SEA_SNAIL);
    public static final RegistryObject<Item> SEA_SNAIL_BUCKET = registerBucket("sea_snail_bucket", ShellfishEntities.SEA_SNAIL);
    public static final RegistryObject<Item> SEA_URCHIN_SPAWN_EGG = registerEgg("sea_urchin_spawn_egg", ShellfishEntities.SEA_URCHIN);
    public static final RegistryObject<Item> SEA_URCHIN_BUCKET = registerBucket("sea_urchin_bucket", ShellfishEntities.SEA_URCHIN);
    public static final RegistryObject<Item> CLAM_SPAWN_EGG = registerEgg("clam_spawn_egg", ShellfishEntities.CLAM);
    public static final RegistryObject<Item> CLAM_BUCKET = registerBucket("clam_bucket", ShellfishEntities.CLAM);
    public static final RegistryObject<Item> OYSTER_SPAWN_EGG = registerEgg("oyster_spawn_egg", ShellfishEntities.OYSTER);
    public static final RegistryObject<Item> OYSTER_BUCKET = registerBucket("oyster_bucket", ShellfishEntities.OYSTER);
    public static final RegistryObject<Item> MUSSEL_SPAWN_EGG = registerEgg("mussel_spawn_egg", ShellfishEntities.MUSSEL);
    public static final RegistryObject<Item> MUSSEL_BUCKET = registerBucket("mussel_bucket", ShellfishEntities.MUSSEL);
    public static final RegistryObject<Item> MOSS_BALL_SPAWN_EGG = registerEgg("moss_ball_spawn_egg", ShellfishEntities.MOSS_BALL);
    ...
    private static RegistryObject<Item> registerFood(String name, int hunger, double saturationModifier, Supplier<? extends Item> item) {
    ...
    private static RegistryObject<Item> registerFood(String name, int hunger, double saturationModifier, Item item) {
    ...
    private static RegistryObject<Item> registerFoodMaxOne(String name, int hunger, double saturationModifier, Item item) {
    ...
    private static RegistryObject<Item> registerFood(String name, int hunger, double saturationModifier, Holder<MobEffect> effect, int duration, int amplifier, float chance) {
    ...
    private static RegistryObject<Item> registerFood(String name, int hunger, double saturationModifier, Holder<MobEffect> effect, int duration, int amplifier, float chance, Supplier<? extends Item> item) {
    ...
    private static RegistryObject<Item> registerFood(String name, int hunger, double saturationModifier, Holder<MobEffect> effect, int duration, int amplifier, float chance, Item item) {
    ...
    private static RegistryObject<Item> registerFood(String name, int hunger, double saturationModifier, Holder<MobEffect> effect, int duration, int amplifier, float chance, Holder<MobEffect> effect2, int duration2, int amplifier2, float chance2) {
    ...
    private static RegistryObject<Item> registerBurnt(String name) {
        return ITEMS.register(name, () -> new Item(new Item.Properties().food((new FoodProperties.Builder()).nutrition(1).saturationModifier((float) 0.1).build(), food().onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.POISON, 400, 1), 1F)).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.CONFUSION, 400, 0), 1F)).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.HUNGER, 400, 1), 1F)).build()).setId(ShellfishTags.createKey(name, Registries.ITEM))));
    }

    private static RegistryObject<Item> registerBurnt(String name, Supplier<? extends Item> item) {
        return ITEMS.register(name, () -> new Item(new Item.Properties().food((new FoodProperties.Builder()).nutrition(1).saturationModifier((float) 0.1).build(), food().onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.POISON, 400, 1), 1F)).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.CONFUSION, 400, 0), 1F)).onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.HUNGER, 400, 1), 1F)).build()).usingConvertsTo(item.get()).setId(ShellfishTags.createKey(name, Registries.ITEM))));
    }
