...
public class ShellfishItems {
    ...
    private static Item registerFood(String name, int hunger, double saturationModifier, ItemConvertible item) {
        return registerItem(name, new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).usingConvertsTo(item).build())));
    }

    private static Item registerFoodMaxOne(String name, int hunger, double saturationModifier, ItemConvertible item) {
        return registerItem(name, new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).usingConvertsTo(item).build()).maxCount(1)));
    }
    ...
    private static Item registerFood(String name, int hunger, double saturationModifier, RegistryEntry<StatusEffect> effect, int duration, int amplifier, float chance, ItemConvertible item) {
        return registerItem(name, new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(hunger).saturationModifier((float) saturationModifier).statusEffect(new StatusEffectInstance(effect, duration, amplifier), chance).usingConvertsTo(item).build())));
    }
    ...
    private static Item registerBurnt(String name, ItemConvertible item) {
        return registerItem(name, new Item(new Item.Settings().food((new FoodComponent.Builder()).nutrition(1).saturationModifier((float) 0.1).statusEffect(new StatusEffectInstance(StatusEffects.POISON, 400, 1), 1F).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA, 400, 0), 1F).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER, 400, 1), 1F).usingConvertsTo(item).build())));
    }
