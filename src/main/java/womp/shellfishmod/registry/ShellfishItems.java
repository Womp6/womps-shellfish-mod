...
public class ShellfishItems {
    ...
    public static final RegistryObject<Item> SHELLFISH_TRAP = registerDurability("shellfish_trap", ShellfishBlocks.SHELLFISH_TRAP_BLOCK, 150);
    public static final RegistryObject<Item> REINFORCED_TRAP = registerDurability("reinforced_trap", ShellfishBlocks.REINFORCED_TRAP, 300);
    ...
    //MISC
    public static final RegistryObject<Item> PEARL = ITEMS.register("pearl", () -> new Item(new Item.Properties().trimMaterial(ShellfishTags.createKey("pearl", Registries.TRIM_MATERIAL)).setId(ShellfishTags.createKey("pearl", Registries.ITEM))));
