...
public class ShellfishModEvents {
    ...
    public static void customTrades(VillagerTradesEvent event) {
        if (event.getType() == ShellfishTrapper.SHELLFISH_TRAPPER_KEY) {
            ...
            // level 1
            factories.get(1).add((entity, random, level) -> new MerchantOffer(
            ...
            // level 2
            factories.get(2).add((entity, random, level) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 1),
            ...
            // level 3
            factories.get(3).add((entity, random, level) -> new MerchantOffer(
            ...
            // level 4
            factories.get(4).add((entity, random, level) -> new MerchantOffer(
            ...
            // level 5
            factories.get(5).add((entity, random, level) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 5),
