...
@EventBusSubscriber(modid = ShellfishMod.MOD_ID, bus = EventBusSubscriber.Bus.GAME)
public class ShellfishNeoForgeEvents {
    ...
    public static void customTrades(VillagerTradesEvent event) {
        if (event.getType() == ShellfishTrapper.SHELLFISH_TRAPPER.value()) {
