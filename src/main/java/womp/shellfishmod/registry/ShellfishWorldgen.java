...
public class ShellfishWorldgen {
    ...
    // MARSH
    public static final RegistryKey<Biome> MARSH = ShellfishUtil.createKey("marsh", RegistryKeys.BIOME);
    ...
    public static RegistryKey<PlacedFeature> of(String id) {
        return ShellfishUtil.createKey(id, RegistryKeys.PLACED_FEATURE);
    }
