...
public class ShellfishTrapScreenHandler extends ScreenHandler {
    ...
    public ShellfishTrapScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(buf.readBlockPos()),
                new ArrayPropertyDelegate(4));
    }

    public ShellfishTrapScreenHandler(int syncId, PlayerInventory inventory2, BlockEntity blockEntity,
