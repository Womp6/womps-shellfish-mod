...
public class ShellfishTags {
    ...
    public static <T> ResourceKey<T> createKey(String name, ResourceKey<? extends Registry<T>> type) {
        return ResourceKey.create(type, ResourceLocation.fromNamespaceAndPath(ShellfishMod.MOD_ID, name));
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> createTag(String name) {
            return TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(ShellfishMod.MOD_ID, name));
        }
    }
    ...
    public static class Blocks {
        ...
        private static TagKey<Block> createTag(String name) {
            return TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(ShellfishMod.MOD_ID, name));
        }
    }
}
