...
public class ShellfishTrapper {
    ...
    private static PointOfInterestType registerPOI(String name, Block block) {
        return PointOfInterestHelper.register(Identifier.of("shellfish", name), 1, 1, ImmutableSet.copyOf(block.getStateManager().getStates())); 
    }

    private static RegistryKey<PointOfInterestType> registerPOIKey(String name) {
        return RegistryKey.of(RegistryKeys.POINT_OF_INTEREST_TYPE, Identifier.of("shellfish", name));
    }

    public static void register() {
        TradeOfferHelper.registerVillagerOffers(SHELLFISH_TRAPPER_KEY, 1, factories -> {
        ...
        TradeOfferHelper.registerVillagerOffers(SHELLFISH_TRAPPER_KEY, 2, factories -> {
            factories.add(((entity, random) -> new TradeOffer(
                new TradedItem(Items.EMERALD, 1),
        ...
        TradeOfferHelper.registerVillagerOffers(SHELLFISH_TRAPPER_KEY, 3, factories -> {
            factories.add(((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(SHELLFISH_TRAPPER_KEY, 4, factories -> {
            factories.add(((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(SHELLFISH_TRAPPER_KEY, 5, factories -> {
            factories.add(((entity, random) -> new TradeOffer(
                new TradedItem(Items.EMERALD, 5),
