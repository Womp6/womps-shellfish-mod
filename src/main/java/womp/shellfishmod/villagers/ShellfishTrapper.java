    ...
    public static void register() {
        TradeOfferHelper.registerVillagerOffers(SHELLFISH_TRAPPER, 1, factories -> {
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.RAW_CRAYFISH, 12),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.RAW_LOBSTER, 12),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .03f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.RAW_CRAB, 12),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.RAW_SHRIMP, 12),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.RAW_SEA_SNAIL, 8),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.RAW_UNI, 16),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.RAW_CLAM, 16),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.RAW_OYSTER, 16),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.RAW_MUSSEL, 16),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .02f
            )));
            factories.add((entity, random) -> new TradeOffer(
        ...
        TradeOfferHelper.registerVillagerOffers(SHELLFISH_TRAPPER, 2, factories -> {
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ShellfishItems.RAW_CRAYFISH, 6),
                new ItemStack(ShellfishItems.COOKED_CRAYFISH, 6),
                8, 10, .03f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ShellfishItems.RAW_LOBSTER, 6),
                new ItemStack(ShellfishItems.COOKED_LOBSTER, 6),
                8, 10, .03f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ShellfishItems.RAW_CRAB, 6),
                new ItemStack(ShellfishItems.COOKED_CRAB, 6),
                8, 10, .03f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ShellfishItems.RAW_SHRIMP, 6),
                new ItemStack(ShellfishItems.COOKED_SHRIMP, 6),
                8, 10, .03f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ShellfishItems.RAW_SEA_SNAIL, 4),
                new ItemStack(ShellfishItems.COOKED_SEA_SNAIL, 4),
                8, 10, .03f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ShellfishItems.RAW_UNI, 8),
                new ItemStack(ShellfishItems.COOKED_UNI, 8),
                8, 5, .03f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ShellfishItems.RAW_CLAM, 8),
                new ItemStack(ShellfishItems.COOKED_CLAM, 8),
                8, 5, .03f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ShellfishItems.RAW_OYSTER, 8),
                new ItemStack(ShellfishItems.COOKED_OYSTER, 8),
                8, 5, .03f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ShellfishItems.RAW_MUSSEL, 8),
        ...
        TradeOfferHelper.registerVillagerOffers(SHELLFISH_TRAPPER, 3, factories -> {
            ...
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishBlocks.ROCKWEED, 32),
                new ItemStack(Items.EMERALD, 1),
                16, 5, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishBlocks.WATER_LETTUCE, 32),
                new ItemStack(Items.EMERALD, 1),
                16, 5, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishBlocks.PADDLEWEED, 16),
                new ItemStack(Items.EMERALD, 1),
                16, 5, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishBlocks.EELGRASS, 16),
                new ItemStack(Items.EMERALD, 1),
                16, 5, .02f
            )));
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishBlocks.SEA_LETTUCE, 16),
                new ItemStack(Items.EMERALD, 1),
                16, 5, .02f
            )));
        });
        ...
        TradeOfferHelper.registerVillagerOffers(SHELLFISH_TRAPPER, 5, factories -> {
            ...
            factories.add(((entity, random) -> new TradeOffer(
                new ItemStack(ShellfishItems.PEARL, 1),
                new ItemStack(Items.EMERALD, 1),
                16, 2, .08f
            )));
        });
